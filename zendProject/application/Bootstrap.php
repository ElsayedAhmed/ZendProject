...
class Bootstrap extends Zend_Application_Bootstrap_Bootstrap
{
	protected function _initPlaceholders()
	{
		...
		// $view->headLink()->prependStylesheet('/zendProject/ZendProject/zendProject/public/assets/css/login.css');

		$view->headScript()->prependFile('/zendProject/ZendProject/zendProject/public/assets/js/custom.js');
		// $view->headScript()->prependFile('/zendProject/ZendProject/zendProject/public/assets/js/login.js');
